...
fn compact_node_for_profile(node: Value, profile: SafetyProfile) -> Value {
    if profile == SafetyProfile::PublicSafe {
...
fn public_safe_evidence_node(node: Value) -> Value {
...
fn public_safe_file_node(node: Value) -> Value {
...
fn public_safe_file_id(raw_id: &str) -> String {
...
fn compact_edge_for_profile(edge: Value, profile: SafetyProfile) -> Value {
    if profile != SafetyProfile::PublicSafe {
...
fn public_safe_graph_endpoint_id(value: Option<&Value>) -> Value {
